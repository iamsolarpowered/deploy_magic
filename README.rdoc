...
2. Copy the example configuration file to config.yml:
...
5. Setup Post-Recieve URL (see "http://github.com/guides/post-receive-hooks":http://github.com/guides/post-receive-hooks)
